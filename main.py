...
bplus=customtkinter.CTkButton(root, text="+", font=("Arial", 20, "bold"), width=60, bg_color="black", cursor="hand2",
                              fg_color="orange", hover_color="orange3", command= lambda :click("+"))
...
b4.grid(row=2, column=0, pady=11)
...
bC=customtkinter.CTkButton(root, text="C", font=("Arial", 20, "bold"), width=60, bg_color="black", cursor="hand2", fg_color="red", hover_color="red3", command=clear)
bC.grid(row=4, column=2)
bdivide=customtkinter.CTkButton(root, text="/", font=("Arial", 20, "bold"), width=60, bg_color="black", cursor="hand2",
                                fg_color="orange", hover_color="orange3", command=lambda :click("/"))
bdivide.grid(row=4, column=3)

bequal=customtkinter.CTkButton(root, text="=", font=("Arial", 20, "bold"), width=280, bg_color="black", cursor="hand2",
                               fg_color="green", hover_color="dark green", command=answer)
